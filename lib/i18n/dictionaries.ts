...
// (emailLocale fallback). The public repo defaults to English; deployments
// serving a Portuguese-speaking care team flip this one line to 'pt' (users
// can always switch per browser via the PT|EN toggle).
